...
def get_git_root_dir():
    ...
    git_root_dir, _ = process.communicate()
    git_root_dir = git_root_dir.decode("utf-8").strip()
    return git_root_dir


def _update_config_from_file(
    config,
    cfg_file=get_git_root_dir() + '/configs/swin_tiny_patch4_window7_224_lite.yaml',
):
    config.defrost()
